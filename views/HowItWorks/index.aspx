    ...
    <div class="container">
      <div class="row centered">
        <div class="col-lg-8 col-lg-offset-2">
          <h3 class="page-title big">How It Works</h3>
        </div>
      </div>
    </div>
  </div>
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <br /><br />
          <center><p class="medium quote">&ldquo;We bridge the gap between investors who want to invest in real estate and borrowers who need capital for their next project.&rdquo;</p></center>
          <br /><br />
        </div>
      </div>
